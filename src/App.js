...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
        ...
        <nav className="mt-6 px-3 flex-1 overflow-y-auto sidebar-nav">
          <div className="space-y-1">
            {[
              ...
              { id: 'phylogenetic', label: 'Phylogenetic Tree', icon: 'tree', description: 'Evolutionary Analysis' },
              ...
              >
                <NavigationIcon type={item.icon} className={`mr-3 h-5 w-5 transition-colors ${
                  currentView === item.id ? 'text-green-600' : 'text-gray-400 group-hover:text-gray-600'
                }`} />
                <div className="text-left flex-1">
                  <div className="font-medium">{item.label}</div>
                  <div className={`text-xs ${
                    currentView === item.id ? 'text-green-600' : 'text-gray-500'
                  }`}>
                    {item.description}
                  </div>
                </div>
          ...
          <div className="mt-8 px-3 pb-6">
            ...
            <div className="space-y-2 text-xs">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-yellow-600 font-medium">2 hrs ago</span>
              </div>
            </div>
          </div>
        </nav>
      ...
      {/* Notifications */}
      <div className="fixed bottom-0 right-0 z-50 p-4 lg:p-6 space-y-2">
